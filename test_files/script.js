...
const testSphere2 = new THREE.Mesh(geometry, material)
...
const torus_geometry = new THREE.TorusGeometry( 20, 3, 20, 100 ); 
const torus_material = new THREE.MeshBasicMaterial( { color: 0xffff0 } ); 
...
const animation = () =>
{
    ...
    testSphere2.position.z = 2

    torus.rotation.y = elapsedTime
    //torus.position.x = Math.sin(elapsedTime * 0.5) * 2
